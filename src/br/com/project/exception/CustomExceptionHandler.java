...
public class CustomExceptionHandler extends ExceptionHandlerWrapper {
	...
	/**
	 * Sobreescreve o método handler que é responsável por manipular as exceções
	 * do JSF
	 */
	@Override
			...
			try {
				...
				if (exception != null
					...
					FacesContext
						...
						&& exception.getMessage() != null
						&& exception.getMessage().indexOf(
								"org.hibernate.StaleObjectStateException") != -1) {
					...
					// tranquiliza o usuário para que ele continue usando o
					// sistema
					FacesContext
							.getCurrentInstance()
							.addMessage(
				...
				// Renderiza a página de erros e exibe as mensagens
